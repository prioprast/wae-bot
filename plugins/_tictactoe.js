...
`.trim()
        ...
        if (room.x !== room.o) await conn.sendButton(room.x, str, 'Tictactoe Game Play', 'Aku menyerah', 'nyerah', m, {
            contextInfo: {
                mentionedJid: this.parseMention(str)
            }
        })
        await conn.sendButton(room.o, str, 'Tictactoe Game Play', 'Aku menyerah', 'nyerah', m, {
            contextInfo: {
                mentionedJid: this.parseMention(str)
            }
        })
